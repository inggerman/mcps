...
kubectl delete job build-agents-platform -n agents-platform 2>&1
echo ""

echo "=== 2. CREATE BUILD JOB (runAsRoot, agents-platform ns) ==="
...
echo "=== 5. CHECK LOGS ==="
kubectl logs -n agents-platform -l job-name=build-agents-platform --tail=20 2>&1
echo ""
