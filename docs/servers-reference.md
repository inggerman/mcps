# Servers Reference
**Última actualización:** 2026-07-15T00:34:53.616195+00:00

Documentación autogenerada con la lista de tools y variables de entorno de cada servidor MCP.

## mcp-tabular
- **Título:** Archivos tabulares
- **Grupo:** Datos
- **Puerto Docker:** 8001
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-tabular run python -m mcp_tabular.server`
...
## mcp-calendar
- **Título:** Días hábiles y divisas
- **Grupo:** Datos
- **Puerto Docker:** 8002
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-calendar run python -m mcp_calendar.server`
...
## mcp-markdown
- **Título:** Archivos Markdown
- **Grupo:** Datos
- **Puerto Docker:** 8003
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-markdown run python -m mcp_markdown.server`
...
## mcp-prompt-engineer
- **Título:** Ingeniería de prompts
- **Grupo:** IA
- **Puerto Docker:** 8004
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-prompt-engineer run python -m mcp_prompt_engineer.server`
...
- **Título:** Structured Output (LLMs JSON Schema)
- **Grupo:** IA
- **Puerto Docker:** 8005
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-structured-output run python -m mcp_structured_output.server`
...
## mcp-fetch
- **Título:** HTTP y web scraping
- **Grupo:** APIs
- **Puerto Docker:** 8006
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-fetch run python -m mcp_fetch.server`
...
## mcp-docker
- **Título:** Gestión Docker
- **Grupo:** Plataforma
- **Puerto Docker:** 8007
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-docker run python -m mcp_docker.server`
...
- **Grupo:** APIs
- **Puerto Docker:** 8008
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-kafka run python -m mcp_kafka.server`
...
## mcp-project-memory
- **Título:** Memoria de proyecto persistente
- **Grupo:** IA
- **Puerto Docker:** 8009
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-project-memory run python -m mcp_project_memory.server`
...
## mcp-llm-router
- **Título:** Ruteo inteligente de LLMs
- **Grupo:** IA
- **Puerto Docker:** 8010
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-llm-router run python -m mcp_llm_router.server`
...
## mcp-git
- **Título:** Operaciones Git
- **Grupo:** Ingeniería
- **Puerto Docker:** 8011
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-git run python -m mcp_git.server`
...
## mcp-github
- **Título:** Integración GitHub
- **Grupo:** APIs
- **Puerto Docker:** 8012
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-github run python -m mcp_github.server`
...
- **Grupo:** Ingeniería
- **Puerto Docker:** 8013
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-code-quality run python -m mcp_code_quality.server`
...
## mcp-architecture
- **Título:** Análisis de arquitectura
- **Grupo:** Ingeniería
- **Puerto Docker:** 8014
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-architecture run python -m mcp_architecture.server`
...
## mcp-event-driven
- **Título:** Event-driven architecture
- **Grupo:** Flujos
- **Puerto Docker:** 8015
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-event-driven run python -m mcp_event_driven.server`
...
## mcp-orchestrator
- **Título:** Orquestación de DAGs
- **Grupo:** Flujos
- **Puerto Docker:** 8016
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-orchestrator run python -m mcp_orchestrator.server`
...
## mcp-best-practices
- **Título:** Documentación retroactiva
- **Grupo:** Flujos
- **Puerto Docker:** 8017
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-best-practices run python -m mcp_best_practices.server`
...
## mcp-ci-cd
- **Título:** Simulación de pipelines
- **Grupo:** Flujos
- **Puerto Docker:** 8018
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-ci-cd run python -m mcp_ci_cd.server`
...
- **Grupo:** Ingeniería
- **Puerto Docker:** 8019
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-design-patterns run python -m mcp_design_patterns.server`
...
- **Título:** Seguridad y compliance
- **Grupo:** Ingeniería
- **Puerto Docker:** 8020
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-security-champion run python -m mcp_security_champion.server`
...
- **Grupo:** Datos
- **Puerto Docker:** 8021
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-database run python -m mcp_database.server`
...
## mcp-filesystem
- **Título:** Filesystem sandbox
- **Grupo:** Datos
- **Puerto Docker:** 8022
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-filesystem run python -m mcp_filesystem.server`
...
## mcp-object-storage
- **Título:** Object Storage S3/MinIO
- **Grupo:** Datos
- **Puerto Docker:** 8023
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-object-storage run python -m mcp_object_storage.server`
...
## mcp-openapi
- **Título:** OpenAPI client
- **Grupo:** APIs
- **Puerto Docker:** 8024
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-openapi run python -m mcp_openapi.server`
...
## mcp-documents
- **Título:** Documentos PDF/DOCX/PPTX
- **Grupo:** Datos
- **Puerto Docker:** 8025
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-documents run python -m mcp_documents.server`
...
## mcp-browser
- **Título:** Automatización web
- **Grupo:** APIs
- **Puerto Docker:** 8026
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-browser run python -m mcp_browser.server`
...
- **Grupo:** Plataforma
- **Puerto Docker:** 8027
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-kubernetes run python -m mcp_kubernetes.server`
...
- **Grupo:** Plataforma
- **Puerto Docker:** 8028
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-observability run python -m mcp_observability.server`
...
## mcp-terraform
- **Título:** Infraestructura como código
- **Grupo:** Plataforma
- **Puerto Docker:** 8029
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-terraform run python -m mcp_terraform.server`
...
## mcp-snyk
- **Título:** Snyk SAST/SCA
- **Grupo:** Plataforma
- **Puerto Docker:** 8030
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-snyk run python -m mcp_snyk.server`
...
## mcp-sonar
- **Título:** SonarQube/SonarCloud
- **Grupo:** Plataforma
- **Puerto Docker:** 8031
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-sonar run python -m mcp_sonar.server`
...
- **Grupo:** Plataforma
- **Puerto Docker:** 8032
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-java-build run python -m mcp_java_build.server`
...
## mcp-agent-runner
- **Título:** Orquestación de agentes
- **Grupo:** Flujos
- **Puerto Docker:** 8033
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-agent-runner run python -m mcp_agent_runner.server`
...
## mcp-personal-vault
- **Título:** Bóveda personal cifrada
- **Grupo:** Personal
- **Puerto Docker:** 8034
- **Comando local:** `uv --directory C:/Users/germa/Documents/IA/mcps/mcp-personal-vault run python -m mcp_personal_vault.server`
